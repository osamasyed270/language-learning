      ...
      <div className="controls">
        ...
        <div className="controls-center">
          <div className="volume-control">
            ...
            <input type="range" name="" value={30} id="volume-range" />
        ...
        <div className="controls-right">
          ...
          <div className="up-arrow-btn">{upArrowIcon}</div>
        </div>
      </div>
    </div>
  )
